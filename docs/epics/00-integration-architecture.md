...
| R4 | Canvas/A2UI proves too limiting for Dashboard | low | medium | Dashboard is a late epic (E10). If Canvas is insufficient, fall back to a separate web server (Express/Fastify). Low migration cost — Amara owns the UI logic. |
