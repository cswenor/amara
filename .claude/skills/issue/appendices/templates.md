...
1. **Title keyword:** `repo:cswenor/amara is:issue "{keyword}" in:title`
2. **Body keyword:** `repo:cswenor/amara is:issue "{keyword}" in:body`
3. **Area + keyword:** `repo:cswenor/amara is:issue label:area:{area} "{keyword}"`
4. **Alternate phrasing:** `repo:cswenor/amara is:issue "{alt_phrase}"`
5. **Open only:** `repo:cswenor/amara is:issue is:open "{keyword}"`
